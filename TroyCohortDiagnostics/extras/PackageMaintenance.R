...
#
# This file is part of TroyCohortDiagnostics
#
...
OhdsiRTools::checkUsagePackage("TroyCohortDiagnostics")
...
OhdsiRTools::createRenvLockFile(rootPackage = "TroyCohortDiagnostics",
                                mode = "description",
