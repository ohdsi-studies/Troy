...
if (Sys.getenv("STRATEGUS_KEYRING_PASSWORD") == "") {
  # set keyring password by adding STRATEGUS_KEYRING_PASSWORD='troy' to renviron
  usethis::edit_r_environ()
  # then add STRATEGUS_KEYRING_PASSWORD='troy', save and close
  # Restart your R Session to confirm it worked
  stop("Please add STRATEGUS_KEYRING_PASSWORD='troy' to your .Renviron file
...
##################################
keyringName <- "troy"
keyringPassword <- "troy" # This password is simply to avoid a prompt when creating the keyring
